...
PadRight V1.5.1 is an Arduino-based project for managing pad vending machines. It supports RFID and cash-based operations, allowing users to interact with the machine via an LCD interface.
